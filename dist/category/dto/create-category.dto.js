...
__decorate([
    (0, class_validator_1.IsMongoId)({ message: 'Parent Category ID must be a valid Mongo ID' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsMongoId)({ message: 'Catalogue ID must be a valid Mongo ID' }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateCategoryDto.prototype, "catalogueId", void 0);
__decorate([
