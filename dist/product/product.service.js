        ...
        const updatedProduct = await this.prisma.$transaction(async (tx) => {
            await tx.product.update({
                ...
                data: {
                    ...
                    nt11_48SetQuantity: dto.nt11_48SetQuantity !== undefined
                        ? dto.nt11_48SetQuantity
                        : undefined,
                    sixToTwelveMonths: dto.sixToTwelveMonths !== undefined
                        ? dto.sixToTwelveMonths
                        : undefined,
                    sixToTwelveMonthsSetQuantity: dto.sixToTwelveMonthsSetQuantity !== undefined
