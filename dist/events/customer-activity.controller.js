...
let CustomerActivityController = class CustomerActivityController {
    ...
    async getSessionDetails(id) {
        ...
        if (!details) {
            throw new common_1.NotFoundException(`Session log '${id}' not found`);
        }
        return details;
    }
};
...
], CustomerActivityController.prototype, "getSessions", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], CustomerActivityController.prototype, "getSessionDetails", null);
...
//# sourceMappingURL=customer-activity.controller.js.map